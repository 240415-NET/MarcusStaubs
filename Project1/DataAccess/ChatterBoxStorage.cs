...
public class ChatterBoxStorage : IChatterBoxStorage
{
    public static readonly string chatPath = "./TempDataStorage/ChatInfo.json";
    ...
    public void InitializeChatterBox()
    {
        ...
        // GeneralChatter innChatter = new GeneralChatter(innList);
        ...
        // ChatterBox myChatterBox = new ChatterBox(innChatter,newKillChatter);
        // string jsonString = JsonSerializer.Serialize(myChatterBox);
        // File.WriteAllText(chatPath,jsonString);
    }
    public ChatterBox GetChatterBox()
    {
        ...
        ChatterBox myChatBox = JsonSerializer.Deserialize<ChatterBox>(File.ReadAllText(chatPath));
        return myChatBox;        
    }
}